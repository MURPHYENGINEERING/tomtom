...
TomTomLocals = {
	...
	["Automatically set waypoint arrow"] = "Autoatisches Setzten des Zielpunktpfeils",
	...
	["This option will not remove any waypoints that are currently set to persist, but only effects new waypoints that get set"] = "Diese Einstellung entfernt keinen Zielpunkt, der als besethend markiert wurde, aber jeden neu gesetzten",
